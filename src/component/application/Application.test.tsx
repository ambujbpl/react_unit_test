...
describe('Application', () => {
  test('renders', () => {
    ...
    const paragraphElement5 = screen.getByText(content => content.startsWith('All'))// custom function match
    expect(paragraphElement5).toBeInTheDocument()
    
    const paragraphElement6 = screen.getByText(content => content.endsWith('mandatory'))// custom function match
